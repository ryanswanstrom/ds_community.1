...
School.create(
  ...
  department: '')
School.create(
  name: 'Mackenzie Presbyterian Institute',
  url: 'http://www.mackenzie.br/27582.html',
  program: 'Big Data Analytics',
  degree: 'Masters',
  country: 'BR',
  state: '',
  ...
  department: '')
School.create(
  name: 'GalvanizeU (University of New Haven)',
  url: 'http://www.galvanizeu.com/',
  program: 'Data Science',
  degree: 'Masters',
  country: 'US',
  state: 'CA',
...
School.create(
    ...
    url: 'http://miamioh.edu/academics/majors-minors/minors/business-analytics.html',
...
School.create(
    name: 'Miami University of Ohio',
    url: 'http://miamioh.edu/fsb/academics/isa/academics/majors/co-major/index.html',
  program: 'I.S. and Analytics',
  degree: 'Bachelors',
    country: 'US',
    state: 'OH',
    online: false,
